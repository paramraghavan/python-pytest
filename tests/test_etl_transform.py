...
def test_process_providers_json_by_group(spark_session):
    sql_mailbox_providers_domain_df = process_providers_json_by_group(spark_session,  mailbox_providers_path =r'tests/data/mailbox-providers/providers.json' , group='gmail')
