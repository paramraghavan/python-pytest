...
def test_sns_trigger_lambda(set_envvars, s3, dynamodb):
    ...
    s3.put_object(Body=s3_object_content.encode(), Bucket=bucket, Key=key, Metadata=metadata)
    ...
    input_event = {'Records': [{'EventSource': 'aws:sns', 'EventVersion': '1.0',
                                'EventSubscriptionArn': 'arn:aws:sns:us-east-1:687162148361:dispatch:3c1c7634-edb6-43e2-9b09-02e781a1148b',
                                'Sns': {'Type': 'Notification', 'MessageId': '07826c52-ed6c-5f38-a87c-3616966df04a',
                                        ...
                                        'Timestamp': '2021-12-28T02:38:57.644Z', 'SignatureVersion': '1',
                                        'Signature': '',
                                        'SigningCertUrl': 'https://sns.us-east-1.amazonaws.com/SimpleNotificationService-7ff5318490ec183fbaddaa2a969abfda.pem',
                                        'UnsubscribeUrl': 'https://sns.us-east-1.amazonaws.com/?Action=Unsubscribe&SubscriptionArn=arn:aws:sns:us-east-1:687162148361:dispatch:3c1c7634-edb6-43e2-9b09-02e781a1148b',
                                        'MessageAttributes': {'AnnualSurveryDatasource': {'Type': 'String',
    ...
    assert result['record_count_from_metadata'] == 10